...
<h3> Αποτελέσματα benchmarking (default values) </h3>
...
<h3> Αποτελέσματα benchmarking (ρολόι 1GHz/3GHz και αποκρίσεις) </h2>
<!-- 
...
<br><br> -->
cpu_cluster.clk_domain.clock <br>

<h4>Χρονισμοί Ρολογιών Συστήματος και CPU Συστήματος</h3>
default:
...
<h3> Αλλαγή της DDR3 με πιο γρήγορο clock </h3>
 
Επιλέξαμε να τρέξουμε το bzip benchmark στον gem5 με το memory configuration από `DDR3_1600_x64` σε `DDR3_2133_x64` και λάβαμε ορισμένα αποτελέσματα. 

1600MHz:

    sim.seconds(ms)               83.982       # Number of seconds simulated
    system.cpu.cpi                1.6797        # CPI: cycles per instruction
    system.cpu.numCycles          167964975       # number of cpu cycles simulated


2133Mhz:

    sim.seconds(ms)               83.609       
    system.cpu.cpi                1.6721       
    system.cpu.numCycles          167217537      
